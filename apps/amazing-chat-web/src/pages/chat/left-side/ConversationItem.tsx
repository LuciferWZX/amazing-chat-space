import { Avatar, AvatarFallback, AvatarImage,LucideIcons } from "@amazing-chat/ui";
...
const ConversationItem = (props:ConversationItemProps) => {
    ...
    const emptyAvatar = useMemo(()=>{
        return(
            <div className={'size-full bg-primary flex items-center justify-center text-xl font-bold'}>
                {username.slice(-2)}
            </div>
        )
    },[username])
